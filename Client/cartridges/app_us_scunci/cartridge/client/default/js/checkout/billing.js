...
//var giftCertBillingHelpers = require('giftcertificates/components/giftCert/billing');
...
function updatePaymentInformation(order) {
    ...
    if (order.billing.payment && order.billing.payment.selectedPaymentInstruments
        ...
        var paymentInstrument = order.billing.payment.selectedPaymentInstruments[0];
...
module.exports = {
    methods: {
        ...
        //updatePaymentInformation: giftCertBillingHelpers.methods.updatePaymentInformation,
