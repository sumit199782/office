...
var bvConstants = require('*/cartridge/scripts/bvLib/libConstants').getConstants();
var BVHelper = require('*/cartridge/scripts/bvLib/libBazaarvoice').getBazaarVoiceHelper();
