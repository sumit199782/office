    ...
    ***************************************************************************** */
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        function Driver(testRunId, communicationUrls, runInfo, options) {
            ...
            _this.browserCloseWindowUrl = communicationUrls.closeWindow;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.closing = true;
                            return [4 /*yield*/, testCafeCore.browser.closeWindow(this.browserCloseWindowUrl, hammerhead__default.createNativeXHR, this.windowId)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2:
